...
<%
	...
	while(sums.next()){
		...
		int sumsActivityID = sums.getInt("ActivityID");
		int demosActivityID = demos.getInt("ActivityID");
		if (sumsActivityID != demosActivityID) {
			throw new RuntimeException("Sums query is mismatched with demos query; sumsActivityID: " + sumsActivityID + "; demosActivityID: " + demosActivityID);
		}
