...
<%
	...
	if(request.getParameter("type").equals("locallevel")){
		...
		demosQuery = "SELECT ministry_LocalLevel.region, SUM(ministry_statistic.invldNewBlvrs) as invldNewBlvrs, SUM(ministry_statistic.invldStudents) invldStudents, SUM(ministry_statistic.invldFreshmen) invldFreshmen, SUM(ministry_statistic.invldSophomores) invldSophomores, SUM(ministry_statistic.invldJuniors) invldJuniors, SUM(ministry_statistic.invldSeniors) invldSeniors, SUM(ministry_statistic.invldGrads) invldGrads, SUM(ministry_statistic.studentLeaders) studentLeaders, SUM(ministry_statistic.volunteers) volunteers, SUM(ministry_statistic.staff) staff, SUM(ministry_statistic.nonStaffStint) nonStaffStint, SUM(ministry_statistic.staffStint) staffStint FROM ministry_statistic INNER JOIN (SELECT ministry_statistic.fk_Activity AS fk_Activity, MAX(ministry_statistic.periodEnd) AS lastDate FROM ministry_statistic WHERE ministry_Statistic.periodEnd < '" + sqlTo + "' AND ministry_Statistic.periodBegin >= '" + sqlFrom + "' GROUP BY fk_Activity) LastActivities ON ministry_statistic.fk_Activity = LastActivities.fk_Activity AND ministry_statistic.periodEnd = LastActivities.lastDate LEFT JOIN ministry_Activity on ministry_statistic.fk_Activity = ministry_Activity.ActivityID LEFT JOIN ministry_LocalLevel on ministry_LocalLevel.teamID = ministry_Activity.fk_teamID WHERE (ministry_statistic.periodEnd < '" + sqlTo + "' AND ministry_statistic.periodBegin >= '" + sqlFrom + "') and ministry_Activity.Strategy in (" + strategyList + ") and region is not null GROUP BY ministry_LocalLevel.region ORDER BY ministry_LocalLevel.region";
		...
		sumsQuery = "SELECT MAX(ministry_TargetArea.TargetAreaID) targetAreaID, MAX(ministry_TargetArea.name) campusName, MAX(ministry_TargetArea.enrollment) enrollment, SUM(ministry_Statistic.exposures) as exposureSum, SUM(ministry_Statistic.exposuresViaMedia) as exposuresViaMediaSum, SUM(ministry_Statistic.evangelisticOneOnOne) as evangelisticOneOnOneSum, SUM(ministry_Statistic.evangelisticGroup) as evangelisticGroupSum, SUM(ministry_Statistic.ongoingEvangReln) as ongoingEvangRelnSum, SUM(ministry_Statistic.decisions) as decisionSum, SUM(ministry_Statistic.decisionsHelpedByMedia) as decisionsHelpedByMediaSum, SUM(ministry_Statistic.decisionsHelpedByOneOnOne) as decisionsHelpedByOneOnOneSum, SUM(ministry_Statistic.decisionsHelpedByGroup) as decisionsHelpedByGroupSum, SUM(ministry_Statistic.decisionsHelpedByOngoingReln) as decisionsHelpedByOngoingRelnSum, SUM(ministry_Statistic.attendedLastConf) as attendSum from ministry_Statistic left join ministry_Activity on (ministry_Statistic.fk_Activity = ministry_Activity.ActivityID) left join ministry_LocalLevel on (ministry_LocalLevel.TeamID = ministry_Activity.fk_TeamID) LEFT JOIN ministry_TargetArea on ministry_TargetArea.targetAreaID = ministry_Activity.fk_targetAreaID WHERE (ministry_LocalLevel.region = '" + request.getParameter("region") + "' and ministry_Statistic.periodEnd < '" + sqlTo + "' AND ministry_Statistic.periodBegin >= '" + sqlFrom + "' and ministry_Activity.Strategy in (" + strategyList + ")) GROUP BY ministry_Activity.ActivityID ORDER BY campusName";
System.out.println(sumsQuery);
		demosQuery = "SELECT ministry_TargetArea.targetAreaID, ministry_TargetArea.name, ministry_Statistic.invldNewBlvrs, ministry_Statistic.invldStudents, ministry_Statistic.invldFreshmen, ministry_Statistic.invldSophomores, ministry_Statistic.invldJuniors, ministry_Statistic.invldSeniors, ministry_Statistic.invldGrads, ministry_Statistic.studentLeaders, ministry_Statistic.volunteers, ministry_Statistic.staff, ministry_Statistic.nonStaffStint, ministry_Statistic.staffStint FROM ministry_Statistic INNER JOIN (SELECT ministry_Statistic.fk_Activity AS fk_Activity, MAX(ministry_Statistic.periodEnd) AS lastDate FROM ministry_Statistic WHERE ministry_Statistic.periodEnd < '" + sqlTo + "' AND ministry_Statistic.periodBegin >= '" + sqlFrom + "' GROUP BY fk_Activity) LastActivities ON ministry_Statistic.fk_Activity = LastActivities.fk_Activity AND ministry_Statistic.periodEnd = LastActivities.lastDate LEFT JOIN ministry_Activity on ministry_Statistic.fk_Activity = ministry_Activity.ActivityID LEFT JOIN ministry_LocalLevel on ministry_LocalLevel.teamID = ministry_Activity.fk_teamID LEFT JOIN ministry_TargetArea on ministry_TargetArea.targetAreaID = ministry_Activity.fk_targetAreaID WHERE (ministry_Statistic.periodEnd < '" + sqlTo + "' AND ministry_Statistic.periodBegin >= '" + sqlFrom + "' and ministry_LocalLevel.region = '" + request.getParameter("region") + "') and ministry_Activity.Strategy in (" + strategyList + ") ORDER BY ministry_TargetArea.name, ministry_Activity.ActivityID";
