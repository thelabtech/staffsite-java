		...
		<td>
			...
			<table width="100%" cellpadding="5" cellspacing="1" <%=bgcolorL%>>
				...
				<tr align="left" valign="middle">
					...
					<td width="90%"><i><%=fontB1%>A graduated Christ-centered laborer is someone who is growing in his/her faith, is multiplying his/her life, and has been sent with a personal strategy to help fulfill the Great Commission.</font></i></td>
				</tr>
