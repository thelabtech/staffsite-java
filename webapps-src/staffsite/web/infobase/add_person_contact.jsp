...
%>
<%= font %>
Search by <i>Last Name</i>. If the person you wish to add is not in the list below, check the spelling of their<BR>last name and try again.  If you still cannot find them, <A HREF="/servlet/InfoBaseController?action=makeNewPerson&purpose=contact&teamID=&activityid=<%=request.getParameter("activityid") %>">click here</A>.
