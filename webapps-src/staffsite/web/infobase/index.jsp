	...
	<tr valign="top"> 
        <td width="130" align="right"> 
			...
			<table width="100%" border="0" bgcolor="#E3E3E3" bordercolor="#7788BB">
				...
				<A style="border:none;"
					HREF="/servlet/InfoBaseController?action=removeTeamMember&accountNo=<%=(String)session.getValue("accountNo")%>&personID=<%= personID %>&locallevelid=<%= thisTeam.get("teamID") %>&teamID=<%= thisTeam.get("teamID") %>&view=IBindex">
