...
function validate() {
	...
	errorMessage = "You didn't enter the following required fields:\n"
		...
		emptyCheck(document.fileForm.webLink,"A link to a resource.");
...
<FORM NAME="fileForm" ACTION="/servlet/CmsController?action=popupUpload" METHOD="POST" ENCTYPE="multipart/form-data" onSubmit="return validate()">
	...
	<input type=hidden name="submitType" value="web">
	<TABLE BORDER="0" CELLPADDING="3" WIDTH="90%" CELLSPACING="0">
		...
		<TR>
			<TD><%=fontB%>Type URL here:</FONT></TD>
			<TD><%=fontB1%>(include http:// or ftp://, eg. http://www.I_like_this_site.com)</font><BR>
			<INPUT NAME="webLink" SIZE="50"></TD>
