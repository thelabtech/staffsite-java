...
//		out.println(font + "The Staff Web is only available to Campus Crusade for Christ staff members. If you are on staff with Campus Crusade, please contact our <A HREF=\"mailto: help@campuscrusadeforchrist.com\">Customer Service Team</A> to update your profile.");
//	} else {
		out.println(font + "The Staff Web is only available to Campus Crusade for Christ staff members. If you are on staff with Campus Crusade, please contact our <A HREF=\"mailto: help@campuscrusadeforchrist.com\">Customer Service Team</A> to update your profile.");
//	}
