...
<table border="0" cellpadding="0" cellspacing="0" width="600">
    ...
    <td colspan="2" valign="top"> <table width="600" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td width="600" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td valign="top"><span class="body"> </span> 
		...
		The color goes in the quotes after the second comma.
			...
			%> <%=contacts.print()%> 
                  ...
                  <p><span class="body">If you believe this information to be 
                    in error, please <a href="mailto:studentlinc@uscm.org">e-mail 
                    us</a>.</span></p>
                  <p>&nbsp;</p></td>
              </tr>
            </table></td>
  ...
  <tr> 
    <td height="15" colspan="2" valign="top"><img src="http://www.godsquad.com/images/spacer.gif" height="10"></td>
  </tr>
  <tr> 
    <td colspan="2" valign="top"><form name=frmDetails action="http://staff.campuscrusadeforchrist.com/servlet/InfoBaseController" method=post>
        <span class="body"> 
        ...
        <strong><font color="#003399">New Search</font></strong><br>
