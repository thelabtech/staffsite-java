...
function updateParent() {
    opener.document.theForm.UniversityFullName.value = document.entercampus.campusname.value;
...
<%
	...
	if(state!=null && !state.equals("")) {
		...
		Source xsl = new StreamSource(this.getServletConfig().getServletContext().getRealPath("/campuslist.xsl"));
