...
function updateParent() {
    opener.document.appForm.RecentSchools.value = document.entercampus.campusname.value;
    opener.document.appForm.UniversityState.value = '<%=state%>';
    self.close();
    return false;
}
function updateParent2(campusname) {
    opener.document.appForm.RecentSchools.value = campusname;
    opener.document.appForm.UniversityState.value = '<%=state%>';
    self.close();
}
function doSubmit() {
	var theform = document.selectcampus;
	theform.submit();
}
