...
function updateReference(refType, accountNo) {
	...
	// 3-4-03 KL: postReferenceInfo(), will create a new reference record for SI.
	if (refType == "S") {
	    opener.document.appForm.Refs9NewStaffNumber.value = accountNo;
	} else if (refType == "D") {
	    opener.document.appForm.Refd9NewStaffNumber.value = accountNo;
	} else if (refType == "R") {
	    opener.document.appForm.Refr9NewStaffNumber.value = accountNo;
	} else if (refType == "F") {
	    opener.document.appForm.Reff9NewStaffNumber.value = accountNo;
	}
	opener.document.appForm.page.value = "refs";
