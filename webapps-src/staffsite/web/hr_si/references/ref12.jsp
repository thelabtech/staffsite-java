...
%>
			<P>
			<B>If you are finished entering the Reference Form and would like to submit it for processing,</B> click on "SUBMIT."  This will send the reference form to the Impact Movement for processing with this applicant's application.
			<P>
...
%>
		...
		<TD ALIGN="CENTER" VALIGN="MIDDLE" CLASS="appquestion">
			<A CLASS="BUTTON" HREF="JavaScript: doPostFormNextAction('refFormSubmit')">Submit</A>
		</TD>
	</TR>
