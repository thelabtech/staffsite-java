	...
	if ((tempString == null) || (tempString.length() < 2)){
		try {
			...
			while (rs.next()) {
				...
				if (value.equalsIgnoreCase("-Not Answered")){
...
%>
<%=qb.printAdminBanner("QuEST 2.0 Advanced Statistics Engine <font size='1'>v0.05", "q2advanced.jsp") %>

<font size="2" face="arial">
<p align = "right">Total number of Quest2 surveys: <b><%= mainCounter %></b></p>
<%
...
%>
<%=whereString%>
<%= doStatsTable("quest2",primaryNice + " " + secondary, primary, whereString, cutOff) %>
...
<p>
<form method="post" action="q2advanced.jsp" name="the_form">
...
click <a href="q2advanced.jsp?submit=campus">here</a>.<br>
<font size="1">What were the notes collected?
click <a href="q2advanced.jsp?submit=notes">here</a>.<br>
<% } %>

<p>
<font size="2" face="arial">
	<a href="q2advanced.jsp">Generate different Stats</a><br>
	<a href="q2stats.jsp">Back to simple Stats</a><br>
</center>
