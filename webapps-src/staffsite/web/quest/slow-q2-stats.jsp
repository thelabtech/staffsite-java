...
<center><%= doStatsTable ("Quest2","Overall Desire to Know God", "desirescale",whereString,"") %></center>
<%}
else if (tempString.equals("How")){ %>
<center><%= doStatsTable ("Quest2","If/How People Have Experienced God", "expGod",whereString,"") %></center>
<%}
else if (tempString.equals("Back")){ %>
<center><%= doStatsTable ("Quest2","Most Common Religious Backgrounds", "relBackground",whereString,"") %></center>
<%}
else if (tempString.equals("Iden")){ %>
<center><%= doStatsTable ("Quest2","Most Common Identity with respect to Religion", "relIdentity",whereString,"") %></center>
<%}
else if (tempString.equals("Word")){ %>
<center><%= doStatsTable ("Quest2","Words to Describe Religious Experience", "words",whereString,"") %></center>
<%}
else if (tempString.equals("Who")){ %>
<center><%= doStatsTable ("Quest2","Who/What is God", "whoIsGod",whereString,"") %></center>
<%}
...
<%}
	...
	<%= doStatsTable ("Quest2","Overall Desire to Know God", "desirescale",whereString,"") %>
	<%= doStatsTable ("Quest2","If/How People Have Experienced God", "expGod",whereString,"") %>
	...
	<!-------------------------------------------------------------------------------------- -->
	<td align="center" valign="top">
	<%= doStatsTable ("Quest2","Most Common Religious Backgrounds", "relBackground",whereString,"") %>
	<%= doStatsTable ("Quest2","Words to Describe Religious Experience", "words",whereString,"") %>
	</td>
	<!-------------------------------------------------------------------------------------- -->
	<td align="center" valign="top">
	<%= doStatsTable ("Quest2","Most Common Identity with respect to Religion", "relIdentity",whereString,"") %>
	<%= doStatsTable ("Quest2","Who/What is God", "whoIsGod",whereString,"") %>
	</td>
	<!-------------------------------------------------------------------------------------- -->
	</tr></table>
<% }
...
<p align="right">	<a href="test.jsp"><b>Get Different Stats</b></a><br>
