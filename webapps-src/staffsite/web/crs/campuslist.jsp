<%@ page
	import="org.alt60m.servlet.*, javax.xml.transform.*, java.net.*, java.util.*, javax.xml.transform.stream.*"%>
<html>
...
function updateParent() {
    opener.document.theForm.Campus.value = document.entercampus.campusname.value;
	//opener.document.Info.campusid.value = '';
    self.close();
    return false;
}
function updateParent2(campusname) {
    opener.document.theForm.Campus.value = campusname;
    self.close();
}
		...
		<table
			...
			<tr>
				...
				<table
					...
					<tr
						...
						<table
							...
							align="center">
							<tr align=center>
								<td>Use this window to select your campus</td>
							</tr>
							<tr
								align=center
								valign=top>
								<td><font
									...
									size="3"><b>Select Your State:</b></font></td>
							</tr>
						</table>
						</td>
					</tr>
				...
				<FORM
					NAME="selectcampus"
					METHOD=POST
					ACTION="campuslist.jsp"><select name=state>
					<option
						value=""
...
%> Don't see your campus?
				<FORM
					METHOD=POST
					NAME="entercampus"
					onSubmit="return updateParent();"><INPUT
					size=40
					NAME="campusname"> <INPUT
					TYPE="submit"
					value="Enter"></FORM>
				<%
	}
