...
try{
	...
	String pageTitle = "Ministry Account Transfer Verification";
%>
...
<TR>
	...
	<TABLE BORDER="0" CELLSPACING="0" WIDTH="100%" CLASS="box">
		<TR>
			<TD CLASS="boxheader" COLSPAN="2">Ministry Account Transfer Verification</TD>
		</TR>
		<TR>
			<TD CLASS="hl" ALIGN="RIGHT" VALIGN="TOP" WIDTH="30%">Last Name</TD>
		...
		<tr>
			...
			<td class="cell">
			<p>
			Please enter 3 or more characters of the last name of the staff member who authorized 
			this transfer, then click "Search." You will be given a list to choose from.
			</p>
			<p>
			If you came to this page by mistake, please click "back" 
			and select a different payment type.
			</p>
			</td>
		</tr>
		<tr>
...
%>
	...
	<table border="0" cellspacing="0" width="100%" class="box">
		...
		<tr>
			<td colspan="2" class="hl">Please select the staff member that can authorize payment by clicking his or her name.</td>
		</tr>
<%
			int counter = 1;
			while (slist.hasNext()) {
