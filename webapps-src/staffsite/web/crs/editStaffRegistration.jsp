	...
	<TR>
		...
		<TABLE
			...
			<TR>
				...
				<%=registration.getPerson().getLastName()%> <A
					CLASS="button"
					TARGET=_blank
			...
			<TR>
				...
				<TD CLASS="cell"><INPUT
					...
					MAXLENGTH=10
					onFocus="pickdate(this)"
					value="<%=formatter.formatDate(registration.getArriveDate() == null ? conference.getDefaultDateStaffArrive() : registration.getArriveDate())%>"></TD>
			</TR>
			<TR>
				<TD
					CLASS="hl"
				...
				<TD CLASS="cell"><INPUT
					...
					MAXLENGTH=10
					onFocus="pickdate(this)"
					value="<%=formatter.formatDate(registration.getLeaveDate() == null ? conference.getDefaultDateStaffLeave() : registration.getLeaveDate())%>"></TD>
			</TR>
			<TR>
				<TD
					CLASS="button"
...
%>
			<TR>
				<TD
					CLASS="cell"
					COLSPAN="7"
					ALIGN="CENTER"><B><%=registration.getPerson().getFirstName()%> <%=registration.getPerson().getLastName()%></B>
