...
<h1 align="center">International SOS Submission Report</h1>
...
<table align=center border="0">
    <tr>
        ...
        <td align="center">&nbsp;</td>
		<td>Corporate Account Number: </td><td><u><strong><u>GLB9101578</u></strong>
        <!-- <td>Corporate Account Number: </td><td><u><strong><u>1MMS1048/Z</u></strong> 4-24-03 kl: comment out--> 
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Date From: </td><td><u><b><%=h.get("DepartureDate")%></b></td><td> &nbsp; </td>
        <td>&nbsp;</td>
        <td>Account to be charged: </td><td><b>&nbsp;</b></td>
		<!-- 5-6-03 kl: remove older OperatingAccountNo -->
    </tr>

	<!-- 4-24-03 kl: add chartfield combination in new row below Account to be charged-->
	<tr>
        <td>&nbsp;</td><td>&nbsp;</td><td> &nbsp; </td>
        <td>&nbsp;</td>

	<td colspan="2"><u><b><%=h.get("OperatingBusinessUnit")%></u>&nbsp;&nbsp;<u><%=h.get("OperatingOperatingUnit")%></u>
	&nbsp;&nbsp;<u><%=h.get("OperatingDeptID")%></u>&nbsp;&nbsp;<u><%=h.get("OperatingProjectID")%></u></b></td>
    </tr>

    <tr>
        <td>Date To: </td><td><u><b><%=h.get("ReturnDate")%></b></u></td><td> &nbsp; </td>
    </tr>
...
<tr><td colspan=6>
		<table align="center">
			<tr><td> &nbsp; </td><td><B>Last Name</B></td><td>&nbsp; </td><td><B>First Name</B></td><td> &nbsp; &nbsp; </td><td><B>On Staff?</B></td><td> &nbsp; &nbsp; </td></tr>
