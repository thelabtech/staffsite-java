...
<tr>
	<td width="38%" valign='top'>
		<p>
		<%=font%><b>Sorry. </font></b>
		<p>The Summer Project tool is temporarily closed for maintenance.</p>
...
<!-- TEMPORARILY HERE FOR MIGRATION  -->
...
<p>
			...
			<td width="25%" valign=top align=right>
				...
				<li><A HREF="/servlet/CmsController?action=browse&catId=9" target='_blank'>Resource Center</a></li>
				<li><A HREF="/servlet/CmsController?action=browse&catId=214" target='_blank'>Leader's Notebook</a></li>
