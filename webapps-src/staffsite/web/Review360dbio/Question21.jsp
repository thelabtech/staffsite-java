...
<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0"> <!-- Big frame inside table-->
	<TR>
		...
		// -->
			...
			<TR>
				<TD <%=bgcolorG%> VALIGN="TOP" COLSPAN="3">
				<BLOCKQUOTE><%=fontB%>
				You have reached the end of the questions. You can go back and change your answers by hitting back, or clicking on one of the options from the Master Question List.
<%
				if(notComplete == 0)
					out.print("If you are finished, press done.");
				else
					out.print("There are still sections that have not been filled out. The incomplete sections are indicated in red on the right. You can click on a section to jump there.");
%>
				</FONT>
				</BLOCKQUOTE>
				</TD>
			...
			<TR>
				<TD <%=bgcolorG%> ALIGN="LEFT" VALIGN="TOP"><A HREF="JavaScript: goTo(19)" onMouseOver="document.backbutton.src='/images/back_bon.gif';" onMouseOut="document.backbutton.src='/images/back_boff.gif';"><IMG NAME="backbutton" SRC="/images/back_boff.gif" BORDER="0" ALIGN="TOP"></A><BR><%=fontB1%>(Saves and goes to<BR> prior question)</font></TD>
				<TD <%=bgcolorG%> ALIGN="CENTER" VALIGN="TOP"><A HREF="JavaScript: goTo(99)" onMouseOver="document.finishlaterbutton.src='/images/finishlater_bon.gif';" onMouseOut="document.finishlaterbutton.src='/images/finishlater_boff.gif';"><IMG NAME="finishlaterbutton" SRC="/images/finishlater_boff.gif" BORDER="0" ALIGN="TOP"></A><BR><%=fontB1%>(Saves and exits 360 Review Tool)</font></TD>
				<TD <%=bgcolorG%> ALIGN="RIGHT" VALIGN="TOP">
<%
				if(notComplete == 0){
%>		
				<A HREF="JavaScript: goTo(22)" onMouseOver="document.donebutton.src='/images/done_bon.gif';" onMouseOut="document.donebutton.src='/images/done_boff.gif';"><IMG NAME="donebutton" SRC="/images/done_boff.gif" BORDER="0" ALIGN="TOP"></A><BR><%=fontB1%>(Saves and exits 360 Review Tool)</font>
<%
				}
%>
				</TD>
