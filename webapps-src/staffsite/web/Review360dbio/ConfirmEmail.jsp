...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" <%=bgcolorW%>> <!--Whole page table-->
	...
	<TR>
	<FORM ACTION="/servlet/Review360Controller?action=composeEmail&lastAction=<%=tub.getValue("lastAction")%>" NAME="theForm" METHOD="post">
