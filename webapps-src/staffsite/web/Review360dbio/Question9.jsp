...
<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0"> <!-- Big frame inside table-->
	<TR>
		...
		<% box.setTitle("III) Leadership Responsibilities - Cast Vision");%>
		<%=box.printTop()%>
		<SCRIPT LANGUAGE="JavaScript">
		<!--
		...
		<FORM METHOD="POST" ACTION="/servlet/Review360Controller?review360Id=<%=my360.get("Review360Id")%>" NAME="submitForm">
			...
			<%=qh.print360Q(q17, (String)my360.get("Q17"), "Q17")%>
			<%=qh.print360R(q18l ,q18r ,q18b ,"Q18", ((Integer)my360.get("Q18")).intValue())%>
			<TR>
				<TD <%=bgcolorG%> ALIGN="LEFT" VALIGN="TOP"><A HREF="JavaScript: goTo(8)" onMouseOver="document.backbutton.src='/images/back_bon.gif';" onMouseOut="document.backbutton.src='/images/back_boff.gif';"><IMG NAME="backbutton" SRC="/images/back_boff.gif" BORDER="0" ALIGN="TOP"></A><BR><%=fontB1%>(Saves and goes to<BR> prior question)</font></TD>
...
%>		
				...
				<TD <%=bgcolorG%> ALIGN="RIGHT" VALIGN="TOP"><A HREF="JavaScript: goTo(10)" onMouseOver="document.nextbutton.src='/images/next_bon.gif';" onMouseOut="document.nextbutton.src='/images/next_boff.gif';"><IMG NAME="nextbutton" SRC="/images/next_boff.gif" BORDER="0" ALIGN="TOP"></A><BR><%=fontB1%>(Saves and goes to<BR> next question)</font></TD>
			</TR>
		</FORM>
		<%=box.printBottom()%>
