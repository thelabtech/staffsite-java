...
<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0"> <!-- Big frame inside table-->
	<TR>
		...
		<% box.setTitle("<B>Summary - </B>FL"+fontR+"OA</FONT>TS</B>");%>
		<%=box.printTop()%>
		<SCRIPT LANGUAGE="JavaScript">
		<!--
		...
		// -->
			...
			<TR>
				<TD <%=bgcolorG%> ALIGN="LEFT" VALIGN="TOP" COLSPAN="3"><%=fontB%> - <I>Comment on how <%=rName%> leads according to our design principles:</I></FONT></TD>
			</TR>
			...
			<%=qh.print360Q(q28o1, (String)my360.get("Q28o1"), "Q28o1")%>
			<%=qh.print360R(q28o2l ,q28o2r ,q28o2b ,"Q28o2", ((Integer)my360.get("Q28o2")).intValue())%>
			<%=qh.print360Q(q28a1, (String)my360.get("Q28a1"), "Q28a1")%>
			<%=qh.print360R(q28a2l ,q28a2r ,q28a2b ,"Q28a2", ((Integer)my360.get("Q28a2")).intValue())%>
			<TR>
				<TD <%=bgcolorG%> ALIGN="LEFT" VALIGN="TOP"><A HREF="JavaScript: goTo(15)" onMouseOver="document.backbutton.src='/images/back_bon.gif';" onMouseOut="document.backbutton.src='/images/back_boff.gif';"><IMG NAME="backbutton" SRC="/images/back_boff.gif" BORDER="0" ALIGN="TOP"></A><BR><%=fontB1%>(Saves and goes to<BR> prior question)</font></TD>
...
%>		
				...
				<TD <%=bgcolorG%> ALIGN="RIGHT" VALIGN="TOP"><A HREF="JavaScript: goTo(17)" onMouseOver="document.nextbutton.src='/images/next_bon.gif';" onMouseOut="document.nextbutton.src='/images/next_boff.gif';"><IMG NAME="nextbutton" SRC="/images/next_boff.gif" BORDER="0" ALIGN="TOP"></A><BR><%=fontB1%>(Saves and goes to<BR> next question)</font></TD>
			</TR>
		</FORM>
		<%=box.printBottom()%>
