...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" <%=bgcolorW%>> <!--Whole page table-->
	...
	<TR VALIGN="TOP">
		<TD WIDTH="140">
			...
			<A HREF="/servlet/Review360LightController?action=showIndex"><%=fontB1%>360 Home</FONT></A><BR>
			<A HREF="/servlet/Review360LightController?action=listAdminSessions"><%=fontB1%>Administration</FONT></A><BR>
...
%>
		<%=box.printTop()%>
		<FORM NAME="submitForm" METHOD="POST" ACTION="/servlet/Review360LightController?action=createNonStaffReviewer">
