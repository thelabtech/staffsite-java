...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" <%=bgcolorW%>> <!--Whole page table-->
	...
	<TR>
		<TD WIDTH="140" VALIGN="TOP">
			...
			<%=fontB1%>Sections complete: <%=fontR1%><%=10 - notComplete%></FONT></FONT><BR>
...
<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0"> <!-- Big frame inside table-->
	<TR>
		...
		<FORM METHOD="POST" ACTION="/servlet/Review360LightController?review360LightId=<%=my360.get("Review360LightId")%>" NAME="submitForm">
			<INPUT TYPE="HIDDEN" NAME="FillOutSection" VALUE="0">
			<INPUT TYPE="HIDDEN" NAME="action" VALUE="editReview360Question">
			<%=qh.print360Q(q1, (String)my360.get("Q1"), "Q1")%>
			<TR>
				<TD <%=bgcolorG%> ALIGN="LEFT" VALIGN="TOP"><A HREF="JavaScript: goTo(0)" onMouseOver="document.backbutton.src='/images/back_bon.gif';" onMouseOut="document.backbutton.src='/images/back_boff.gif';"><IMG NAME="backbutton" SRC="/images/back_boff.gif" BORDER="0" ALIGN="TOP"></A><BR><%=fontB1%>(Saves and goes to<BR> prior question)</font></TD>
...
%>		
				...
				<TD <%=bgcolorG%> ALIGN="RIGHT" VALIGN="TOP"><A HREF="JavaScript: goTo(2)" onMouseOver="document.nextbutton.src='/images/next_bon.gif';" onMouseOut="document.nextbutton.src='/images/next_boff.gif';"><IMG NAME="nextbutton" SRC="/images/next_boff.gif" BORDER="0" ALIGN="TOP"></A><BR><%=fontB1%>(Saves and goes to<BR> next question)</font></TD>
			</TR>
		</FORM>
		<%=box.printBottom()%>
