...
<%
	...
	String strSubject = "360 Review - Light for ";
...
<TABLE WIDTH="100%" BORDER="0" CELLPADDING="3" CELLSPACING="0"> <!-- Big frame inside table-->
	...
	<%=box.printTop()%>
	<FORM ACTION="/servlet/Review360LightController?action=sendEmail" METHOD="POST" NAME="submitForm">
	<TR>
...
Greetings!
<%="\n"%>
For this year's developmental reviews for our National Team, we are experimenting with a simplified 
tool.  Would you please take some time to answer each question, explaining and sighting examples 
where possible? Thank you very much.  
<%="\n"%>
All you need to do is go to the staff site, click on the tools section, click 360 Review, 
and fill out the online form with 9 questions(a shortcut is provided below). If you could do 
this before <%=tub.getValue("DueDate")%>, I would appreciate it.
<%="\n"%>
In His grace,
