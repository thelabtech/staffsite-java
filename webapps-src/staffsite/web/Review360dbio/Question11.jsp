...
<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0"> <!-- Big frame inside table-->
	<TR>
		...
		<% box.setTitle("III) Leadership Responsibilities - Align");%>
		<%=box.printTop()%>
		<SCRIPT LANGUAGE="JavaScript">
		<!--
		...
		<FORM METHOD="POST" ACTION="/servlet/Review360Controller?review360Id=<%=my360.get("Review360Id")%>" NAME="submitForm">
			...
			<%=qh.print360Q(q21, (String)my360.get("Q21"), "Q21")%>
			<%=qh.print360R(q22l ,q22r ,q22b ,"Q22", ((Integer)my360.get("Q22")).intValue())%>
			<TR>
				<TD <%=bgcolorG%> ALIGN="LEFT" VALIGN="TOP"><A HREF="JavaScript: goTo(10)" onMouseOver="document.backbutton.src='/images/back_bon.gif';" onMouseOut="document.backbutton.src='/images/back_boff.gif';"><IMG NAME="backbutton" SRC="/images/back_boff.gif" BORDER="0" ALIGN="TOP"></A><BR><%=fontB1%>(Saves and goes to<BR> prior question)</font></TD>
...
%>		
				...
				<TD <%=bgcolorG%> ALIGN="RIGHT" VALIGN="TOP"><A HREF="JavaScript: goTo(12)" onMouseOver="document.nextbutton.src='/images/next_bon.gif';" onMouseOut="document.nextbutton.src='/images/next_boff.gif';"><IMG NAME="nextbutton" SRC="/images/next_boff.gif" BORDER="0" ALIGN="TOP"></A><BR><%=fontB1%>(Saves and goes to<BR> next question)</font></TD>
			</TR>
		</FORM>
		<%=box.printBottom()%>
