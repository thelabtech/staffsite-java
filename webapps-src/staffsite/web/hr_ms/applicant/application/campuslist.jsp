...
<%
	...
	if(state!=null && !state.equals("")) {
		...
		Source xsl = new StreamSource(this.getServletConfig().getServletContext().getRealPath("/hr_ms/applicant/application/campuslist.xsl"));
...
%>
		<P>Don't see your campus? Enter the full campus name here and click Enter:
