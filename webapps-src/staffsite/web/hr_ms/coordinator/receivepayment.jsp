...
<input type="hidden" name="action" value="actionReceivePaymentFind">
  ...
  if (people.keySet().size()>0)
  {
   ...
   out.println(" <TR>");
	...
	for (Iterator i = people.keySet().iterator(); i.hasNext(); )
	{
	   ...
	   out.println("<TR><TD width=\"20%\"><A HREF='/servlet/MSController?action=actionPostReceivePayments&" + link + "'>" + key + "</A></TD>");
