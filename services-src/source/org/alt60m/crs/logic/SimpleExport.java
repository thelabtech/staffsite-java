...
/**
 * Exports a simplified database structure. It doesn't export all the
 * information, and it puts all of the registrant info into one giant table
 * instead of splitting it up into more manageable chunks. This is helpful for
 * smaller conferences, but not so helpful for large ones.
 * 
...
public class SimpleExport {
	 ...
	 * @throws IOException
	 */
	public SimpleExport(int conferenceId, Connection connection,
	...
	private String buildRegistrantsQuery() throws SQLException {
		...
		String registrantsFromClause = " FROM  crs_registrationtype regType, crs_registration reg"
				...
				+ " regType.label," + " reg.preRegistered";
