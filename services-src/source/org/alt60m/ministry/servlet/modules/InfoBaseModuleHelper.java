...
public class InfoBaseModuleHelper {
    ...
    public static Hashtable<String,Object>infotize(Object tify){
 	   ...
 	   if(tify.getClass().getCanonicalName().equals("org.alt60m.ministry.model.dbio.Person")){
    ...
    public int getActivityCount() throws Exception {
        try {
			return InfoBaseModuleQueries.getActivityCount();
        }
        catch (Exception e) {
    ...
    public int getActivityCountCurrent() throws Exception {
        try {
			return InfoBaseModuleQueries.getActivityCountCurrent();
        }
        catch (Exception e) {
	...
	public Collection getCampusList(String searchBy, String searchText) throws Exception {
		try {
			...
			if ("region".equalsIgnoreCase(searchBy)) {
				colTAs = InfoBaseModuleQueries.getNonSecureTargetAreasByRegion(searchText);
			} else if ("state".equalsIgnoreCase(searchBy)) {
				colTAs = InfoBaseModuleQueries.getNonSecureTargetAreasByState(searchText);
			} else if ("name".equalsIgnoreCase(searchBy)) {
				colTAs = InfoBaseModuleQueries.getNonSecureTargetAreasByName(searchText);
			} else if ("city".equalsIgnoreCase(searchBy)) {
				colTAs = InfoBaseModuleQueries.getNonSecureTargetAreasByCity(searchText);
			} else if ("zip".equalsIgnoreCase(searchBy)) {
				colTAs = InfoBaseModuleQueries.getNonSecureTargetAreasByZip(searchText);
			} else if ("country".equalsIgnoreCase(searchBy)) {
				colTAs = InfoBaseModuleQueries.getNonSecureTargetAreasByCountry(searchText);
			} else {
				colTAs = new Vector();
			}
			return colTAs;
	...
	public Collection getCampusListLocator(String searchBy, String searchText) throws Exception {
		try {
			...
			if ("region".equalsIgnoreCase(searchBy)) {
				colTAs = InfoBaseModuleQueries.getAllTargetAreasByRegion(searchText);
			} else if ("state".equalsIgnoreCase(searchBy)) {
				...
				if("CA1".equalsIgnoreCase(searchText)) {
					...
					colTAs = InfoBaseModuleQueries.getAllTargetAreasByStateAndZip(searchText, _number);
				}
					...
					colTAs = InfoBaseModuleQueries.getAllTargetAreasByState(searchText);
				}

			} else if ("name".equalsIgnoreCase(searchBy)) {
				colTAs = InfoBaseModuleQueries.getAllTargetAreasByName(searchText);
			} else if ("city".equalsIgnoreCase(searchBy)) {
				colTAs = InfoBaseModuleQueries.getAllTargetAreasByCity(searchText);
			} else if ("zip".equalsIgnoreCase(searchBy)) {
				colTAs = InfoBaseModuleQueries.getAllTargetAreasByZip(searchText);
			} else if ("country".equalsIgnoreCase(searchBy)) {
				colTAs = InfoBaseModuleQueries.getAllTargetAreasByCountry(searchText);
			} else {
				colTAs = new Vector();
			}
			return colTAs;
...
//		Vector<Hashtable<String, Object>> enrollmentLatLong=new Vector<Hashtable<String, Object>>( InfoBaseModuleQueries.getEnrollmentForZip());
//		Hashtable<String,Hashtable<String,Double>>zips=new Hashtable<String,Hashtable<String,Double>>( InfoBaseModuleQueries.getZipsLatLong());
...
//	}
    ...
    public Collection getLocalLevelTeamsByRegionExclusive(String region) throws Exception {
        try {
			return InfoBaseModuleQueries.getLocalLevelTeamsByRegionExclusive(region);
        } catch (Exception e) {
	...
	public Collection<Hashtable<String, Object>> getRegionalStats(String region, List<Hashtable<String, Object>> allDates) throws Exception {
        try {
			Collection<Hashtable<String, Object>> c = ObjectHashUtil.list(InfoBaseModuleQueries.getRegionalStats(region.toUpperCase(), (Date) allDates.get(0).get("PeriodBegin"), (Date) allDates.get(15).get("PeriodEnd")));
			return c;
		}
        catch (Exception e) {
    ...
    public RegionalTeam getRegionalTeam(String region) throws Exception {
        try {
			return InfoBaseModuleQueries.getRegionalTeam(region);
        }
        catch (Exception e) {
    ...
    public int getReportedCnt(Date since) throws Exception {
        try {
 			return InfoBaseModuleQueries.getReportedCnt(since);
       }
        catch (Exception e) {
    ...
    public Collection<Hashtable<String, Object>> getStaffListForRegion(String region) throws Exception {
		...
		if (staffByRegionCache.lastUpdated == null || cal.after(staffByRegionCache.lastUpdated)) {
	        for(int cnt=0;cnt<_abbrevRegion.length;cnt++) {
				...
				Collection<Staff> staff = InfoBaseModuleQueries.listStaffByRegion(thisRegion);
    ...
    public Collection getTargetAreasByRegion(String region) throws Exception {
        try {
            Collection teams = InfoBaseModuleQueries.getTargetAreasByRegion(region);
			return teams;
        } catch (Exception e) {
    ...
    public Vector<Hashtable<String,String>> getTargetAreasByRegionWithoutStrategy(String region,String strategy) throws Exception {
        try {
        	Vector<Hashtable<String,String>>tas = InfoBaseModuleQueries.getTargetAreasByRegionWithoutStrategy(region,strategy);
			return tas;
        } catch (Exception e) {
	...
	public Collection<Hashtable<String, Object>> getTargetAreaStats(String targetAreaId, List<Hashtable<String, Object>> allDates) throws Exception {
        try {
			Collection<Hashtable<String, Object>> c = ObjectHashUtil.list(InfoBaseModuleQueries.listStatsForTargetArea(targetAreaId, (Date)allDates.get(0).get("PeriodBegin"),
	...
	public Collection<Hashtable<String, Object>> getBridgesTargetAreaStats(String targetAreaId, List<Hashtable<String, Object>> allDates, String strategy, String peopleGroup) throws Exception {
        try {
			...
			Collection<Hashtable<String, Object>> c = ObjectHashUtil.list(InfoBaseModuleQueries.listBridgesStatsForTargetArea(targetAreaId, (Date)allDates.get(0).get("PeriodBegin"),
    ...
    public Collection<Hashtable<String, Object>> listStaff(String searchBy, String searchText) throws Exception {
		try {
			...
			if (searchBy.equals("lastname")) {
				Vector staffList = InfoBaseModuleQueries.listStaffByLastName(searchText);
    ...
    public Collection listStaffByRegionSQL(String region) throws Exception {
        try {
			return InfoBaseModuleQueries.listStaffHashByRegion(region);
        }
        catch (Exception e) {
    ...
    public Collection shortListStaffByRegionSQL(String region) throws Exception {
        try {
			return InfoBaseModuleQueries.shortListStaffHashByRegion(region);
        }
        catch (Exception e) {
    ...
    public Collection listStaffHashByLastName(String lastName) throws Exception {
        try {
			return InfoBaseModuleQueries.listStaffHashByLastName(lastName);
        }
        catch (Exception e) {
    ...
    public void removePersonContact(String personID,String activityId) throws Exception {
        try {
            InfoBaseModuleQueries.removePersonContact(personID, activityId );
        }
        catch (Exception e) {
    ...
    public void savePersonContact(String personID, String activityId) throws Exception {
        try {
        	InfoBaseModuleQueries.removePersonContact(personID,activityId);
            InfoBaseModuleQueries.savePersonContact(personID,activityId);
...
*/
    ...
    public void saveRegionInfo(Map<String, String> request, String region) throws Exception {
        try {
            RegionalTeam rt = InfoBaseModuleQueries.getRegionalTeam(region);
...
//		Vector<Contact> currentContacts = InfoBaseModuleQueries.getMovementContacts(activityId);
