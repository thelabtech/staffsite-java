...
public class StatHelper extends org.alt60m.ministry.servlet.modules.InfoBaseModuleHelper {
	...
	public static ActionResults fastStats(ArrayList<Activity> activities)throws Exception //IJK
    {
    	...
    	{
            String strategy=activity.getStrategy();  //if strategy is Bridges, go thru each peopleGroup option and invoke a stat object/ActionResult for it.
        	...
        	while(peopleIter.hasNext())
        	{
                ...
                {
                	throw new MissingTargetAreaIdException("Activity " + activity.getActivityId() + " does not have an associated targetArea");
                }
                ...
                Collection<Hashtable<String, Object>> stats = getBridgesTargetAreaStats(targetAreaId, allDates, strategy, peopleGroup);
                ...
                multiResults.addActionResults(results.getValue("displayname")+"_"+activity.getActivityId(),results);
        	}
        }
    	return multiResults;
    }
