    ...
    public void saveTargetAreaInfo(ActionContext ctx) {
        try {
        	...
        	content(ctx);
            	...
            	LocationHelper ibt = new LocationHelper();
            	List admins=Arrays.asList("todd.gross@uscm.org","mark.kohman@uscm.org","todd.gross@cojourners.com","ruth.rhea@uscm.org","justin.sabelko@uscm.org","robin.muscarella@studentventure.org","josh.starcher@uscm.org");
