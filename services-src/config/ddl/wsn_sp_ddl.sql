DROP TABLE IF EXISTS wsn_sp_WsnProject;
...
ALTER TABLE wsn_sp_WsnProject ADD CONSTRAINT PK_wsn_sp_WsnProject PRIMARY KEY (WsnProjectID);
CREATE INDEX IDX_wsn_sp_WsnProject_fk_isAPD ON wsn_sp_WsnProject (fk_isAPD);
CREATE INDEX IDX_wsn_sp_WsnProject_fk_isPD ON wsn_sp_WsnProject (fk_isPD);
CREATE INDEX IDX_wsn_sp_WsnProject_fk_isCoord ON wsn_sp_WsnProject (fk_isCoord);


DROP TABLE IF EXISTS wsn_sp_WsnApplication;
...
ALTER TABLE wsn_sp_WsnApplication ADD CONSTRAINT PK_wsn_sp_WsnApplication PRIMARY KEY (WsnApplicationID);
CREATE INDEX IDX_wsn_sp_WsnApplication_fk_isMember ON wsn_sp_WsnApplication (fk_isMember);
CREATE INDEX IDX_wsn_sp_WsnApplication_fk_wsnSpouse ON wsn_sp_WsnApplication (fk_wsnSpouse);
CREATE INDEX IDX_wsn_sp_WsnApplication_fk_childOf ON wsn_sp_WsnApplication (fk_childOf);
