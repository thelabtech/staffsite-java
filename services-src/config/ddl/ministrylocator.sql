drop table if exists ministrylocator_campus;
...
create index ministrylocator_campus_idx_2 on ministrylocator_campus(country);

drop table if exists ministrylocator_ministry;
...
drop table if exists ministrylocator_contact;
...
drop table if exists ministrylocator_assoc_ministry_contact;
CREATE TABLE ministrylocator_assoc_ministry_contact
(
	ministryID varchar(16) NOT NULL,
	contactID varchar(16) NOT NULL
);
ALTER TABLE ministrylocator_assoc_ministry_contact ADD PRIMARY KEY (ministryID, contactID);
