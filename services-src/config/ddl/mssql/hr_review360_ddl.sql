...
CREATE INDEX index1 ON hr_review360_Review360 (fk_ReviewSessionID);


DROP TABLE hr_review360_ReviewSessionLight;
CREATE TABLE hr_review360_ReviewSessionLight(
	ReviewSessionLightID varchar(64) not null,
	name varchar(80) null,
	purpose varchar(255) null,
	dateDue datetime null,
	dateStarted datetime null,
...
CREATE TABLE hr_review360_Review360Light(
	Review360LightID varchar(64) not null,
	reviewedByID varchar(64) null,
	dateStarted datetime null,
	dateCompleted datetime null,
	dateDue datetime null,
	...
	q8 text null,
	q9 text null,
	fk_ReviewSessionLightID varchar(64) null,
	PRIMARY KEY(Review360LightID)
);


CREATE INDEX index1 ON hr_review360_Review360Light (fk_ReviewSessionLightID);