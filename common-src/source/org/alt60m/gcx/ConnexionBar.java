...
public class ConnexionBar {
	...
	public static String getBar(String pgtiou, String guid) {
		...
		String barTicketService = "https://www2.mygcx.org/module/CampusStaff/omnibar/omnibar";
		String barService = "https://www2.mygcx.org/module/CampusStaff/omnibar/omnibar"; //should be www, not working
