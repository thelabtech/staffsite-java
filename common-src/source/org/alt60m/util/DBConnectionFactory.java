...
public class DBConnectionFactory {
    ...
    private static final String ORACLE_PROD_URL = "jdbc:oracle:thin:@(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = hart-a821v)(PORT = 1521)) (ADDRESS = (PROTOCOL = TCP)(HOST = hart-a841v)(PORT = 1521)) (LOAD_BALANCE = yes) (CONNECT_DATA = (SERVER = DEDICATED) (SERVICE_NAME = batch.ccci.org) (FAILOVER_MODE = (TYPE = SELECT) (METHOD = BASIC) (RETRIES = 180) (DELAY = 5) ) ) ) ";
