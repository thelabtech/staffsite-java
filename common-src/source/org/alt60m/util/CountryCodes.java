...
public class CountryCodes
{
	...
	public static final String[] countryList = new String[]  {
		"United States","USA","Canada","CAN","Albania","ALB","American Samoa","ASM","Andorra","AND","Anguilla","AIA",
			...
			"Heard and McDonald Islands","HMD","Honduras","HND","Hong Kong","HKG","Hungary","HUN","HZB","HZB","HZC","HZC",
			...
			"Tokelau","TKL","Tonga","TON","Trinidad and Tobago","TTO","Turkey","TUR","Turkmenistan","TKM",
